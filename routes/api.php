...
Route::prefix('products')->group(function () {
    ...
    Route::get('/public/{product}',[ProductController::class, 'show']);
    Route::get('/search',          [ProductController::class, 'search']);
    Route::get('/tag/{tag}',       [ProductController::class, 'getByTag']);
});
...
/*
|--------------------------------------------------------------------------
| Public Routes — Webhooks (HMAC-signed, no Bearer token)
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| Public Routes — Shopify (called before auth check)
|--------------------------------------------------------------------------
*/
...
Route::prefix('shopify')->group(function () {
    ...
    Route::patch('/shops/{shop}',  [ShopifyController::class, 'updateShop']);
    Route::delete('/shops/{shop}', [ShopifyController::class, 'disconnectShop']);
});
